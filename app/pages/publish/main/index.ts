import { IChooseSourceOption, ISelectedSourceItem, ISelectedSourceList } from '../../../libs/publish'
...
Page({
  data: {
    ...
    selectedSourceList: [] as ISelectedSourceList,
    selectedVideo: '',
    actionSheetItemList: [
      '拍摄照片',
      '拍摄视频',
  ...
  selectLocalPhotoHander(actionOption: IChooseSourceOption) {
    ...
    wx.chooseImage({
      ...
      async success(res: WechatMiniprogram.ChooseImageSuccessCallbackResult) {
        ...
        let selectedSourceList: ISelectedSourceList = [...self.data.selectedSourceList]
