import { ISelectedSourceList } from '../../../libs/publish'
...
Page({
  ...
  showActionSheetHander() {
    const selectedSourceList: ISelectedSourceList = [...this.data.selectedSourceList]
    selectedSourceList[this.data.swiperCurrentIndex].showActionSheet = true
    this.setData({ selectedSourceList })
  },
  hideActionSheetHander(callback: () => void) {
    const selectedSourceList: ISelectedSourceList = [...this.data.selectedSourceList]
